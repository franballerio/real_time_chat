-- 1. Users Table
CREATE TABLE users (
    _id UUID PRIMARY KEY DEFAULT gen_random_uuid(), -- Keeping _id to match your code
...
CREATE TABLE messages (
    ...
    receiver_id UUID NOT NULL REFERENCES users(_id) ON DELETE CASCADE, -- Fixed spelling from 'reciever'
    text TEXT NOT NULL,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
